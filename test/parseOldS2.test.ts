...
describe("serialize and parse vector tile points", () => {
  const data = new Uint8Array([
    10, 63, 120, 1, 10, 6, 112, 111, 105, 110, 116, 115, 40, 128, 64, 18, 15,
    120, 1, 10, 2, 0, 0, 16, 1, 26, 5, 9, 186, 59, 154, 88, 18, 15, 120, 2, 10,
    2, 0, 1, 16, 1, 26, 5, 9, 160, 80, 184, 73, 26, 4, 110, 97, 109, 101, 34, 3,
    10, 1, 97, 34, 3, 10, 1, 99,
  ]);
...
describe("serialize and parse vector tile lines", () => {
  const data = new Uint8Array([
    10, 100, 120, 1, 10, 5, 108, 105, 110, 101, 115, 40, 128, 64, 18, 28, 120,
    1, 10, 2, 0, 0, 16, 2, 26, 18, 9, 160, 57, 160, 57, 26, 138, 6, 138, 6, 251,
    29, 251, 29, 255, 3, 255, 3, 18, 42, 120, 2, 10, 2, 1, 1, 16, 2, 26, 32, 9,
    238, 41, 238, 41, 26, 184, 9, 184, 9, 159, 7, 159, 7, 232, 8, 232, 8, 9,
    204, 3, 204, 3, 18, 154, 4, 154, 4, 185, 6, 185, 6, 26, 1, 97, 26, 1, 98,
    34, 2, 40, 1, 34, 2, 40, 2,
  ]);
...
describe("serialize and parse vector tile polygons", () => {
  const data = new Uint8Array([
    10, 172, 1, 120, 1, 10, 8, 112, 111, 108, 121, 103, 111, 110, 115, 40, 128,
    64, 18, 40, 120, 1, 10, 2, 0, 0, 16, 3, 26, 30, 9, 138, 40, 138, 40, 26, 0,
    0, 216, 20, 216, 20, 0, 0, 15, 9, 191, 13, 191, 13, 26, 0, 0, 133, 4, 133,
    4, 0, 0, 15, 18, 99, 120, 2, 10, 2, 1, 1, 16, 4, 26, 89, 9, 236, 40, 236,
    40, 34, 0, 0, 224, 7, 224, 7, 154, 34, 154, 34, 0, 0, 15, 9, 147, 28, 147,
    28, 26, 164, 17, 164, 17, 0, 0, 163, 17, 163, 17, 15, 9, 141, 8, 141, 8, 26,
    190, 5, 190, 5, 0, 0, 189, 5, 189, 5, 15, 12, 9, 154, 25, 154, 25, 34, 0, 0,
    178, 17, 178, 17, 142, 4, 142, 4, 0, 0, 15, 9, 217, 3, 217, 3, 26, 0, 0,
    219, 2, 219, 2, 0, 0, 15, 12, 26, 1, 97, 26, 1, 98, 34, 2, 40, 1, 34, 2, 40,
    2,
  ]);
