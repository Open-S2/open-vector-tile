...
import { MapboxVectorFeature, MapboxVectorLayer } from '../src';
// import {
//   BaseVectorTile,
//   BaseVectorLayer,
...
//     // Properties
//     expect(line1.properties).toEqual({ name: "a" });
//     expect(line2.properties).toEqual({ name: "c" });
...
//   // Step 1: Create
//   const poly1 = BaseVectorPolysFeature.fromJSON(
//     [
//       [
//         [
//           { x: 2565, y: 2565 },
...
//     0,
//   );
//   const polys2 = BaseVectorPolysFeature.fromJSON(
//     [
//       [
//         [
//           { x: 2614, y: 2614 },
...
//     // Properties
//     expect(poly1.properties).toEqual({ name: "a" });
